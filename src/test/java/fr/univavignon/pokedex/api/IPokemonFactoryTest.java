...
public class IPokemonFactoryTest {
    ...
    public void setUp() {
        ...
        Aquali = Aquali = new Pokemon(133, "Aquali", 186, 168, 90, 613, 202, 2000, 3, 56.0);
        Charmander = new Pokemon(-5, "Charmander", -100, -613, -1, -613, -100, -2000, -3, -56.0);
        Mew = new Pokemon(Integer.MAX_VALUE, "Mew", Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Float.MAX_VALUE);
    }
    ...
    public void MockCreateValidPokemon () {
        ...
        assertEquals(64, createdBulbasaur.getHp());  // Ceci garantit que la méthode a bien pris en compte les HP fournis
        assertEquals(202, createdAquali.getHp());  // Ceci garantit que la méthode a bien pris en compte les HP fournis
